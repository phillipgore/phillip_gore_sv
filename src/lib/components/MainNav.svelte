...
<div class="container-lg full-height bg-gray-lightest bg-pr-white box-shadow-10">
	...
	<div class="pos-middle full-width txt-tn-center">
         <img class="avatar img-height-tn-90 img-height-md-144" alt="Phillip's Face" src={avatar} />
		...
		<a href="/developer" class="bg-gray-lighter cl-gray-darker bd-radius-3 p-tn-tb-6 p-tn-rl-18 m-tn-r-3">Developer</a> 
		<a href="/preacher" class="bg-gray-lighter cl-gray-darker bd-radius-3 p-tn-tb-6 p-tn-rl-18 m-tn-l-3">Preacher</a>
	</div>
